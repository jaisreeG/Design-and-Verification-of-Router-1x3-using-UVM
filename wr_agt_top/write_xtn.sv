...
class err_xtn extends write_xtn;

        `uvm_object_utils(err_xtn)

        extern function new(string name = "err_xtn");
        extern function void do_print(uvm_printer printer);
        extern function void post_randomize();

endclass

function err_xtn::new(string name = "err_xtn");
        super.new(name);
endfunction

function void err_xtn::do_print(uvm_printer printer);
        super.do_print(printer);
endfunction

function void err_xtn::post_randomize();
